...
import sys
print(sys.path)
'/home/ideapad5/Нетология. Python-разработчик с нуля. PD-58/Netology_Diplom'
sys.path.append('/home/ideapad5/Нетология. Python-разработчик с нуля. PD-58/Netology_Diplom/orders/APIbackend'),

import APIbackend.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.CharField(blank=True, max_length=15, verbose_name='Housing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='APIbackend.contact', verbose_name='Контакт')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='APIbackend.category', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_infos', to='APIbackend.product', verbose_name='Продукт')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(blank=True, max_length=40, verbose_name='Post')),
            ...
            managers=[
                ('objects', APIbackend.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_parameters', to='APIbackend.parameter', verbose_name='Параметр')),
                ('product_info', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_param_info', to='APIbackend.productinfo', verbose_name='Информация о продукте')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='shop',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='shop_infos', to='APIbackend.shop', verbose_name='Магазин'),
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(verbose_name='Количество')),
                ('order', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='APIbackend.order', verbose_name='Заказ')),
                ('product_info', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items_info', to='APIbackend.productinfo', verbose_name='Информация о продукте')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='category',
            name='shops',
            field=models.ManyToManyField(blank=True, related_name='categories', to='APIbackend.shop', verbose_name='Магазины'),
        ),
